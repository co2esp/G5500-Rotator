...
#define SSID     "The name of the WiFi AP"      // SSID to join (or broadcast)
#define PASSWD   "password"  // wiFi password
#define HOSTNAME "serial_bridge"     // hostname for STA mode mDNS
...
#define TX_PWR           10.0f // Wifi Tx Power Station Mode
...
#define OTA_HOSTNAME "SERIAL-BRIDGE" // OTA HOSTNAME ID
...
#define SERIAL0_TXPIN 4           // transmit Pin UART0
#define SERIAL0_RXPIN 5          // receive Pin UART0
...
/*************************  COM Port 2 *******************************/
#define UART_BAUD2 9600           // Baudrate UART2         (ESP32 only)
#define SERIAL_PARAM2 SERIAL_8N1    // Data/Parity/Stop UART2 (ESP32 only)
#define SERIAL2_TXPIN 21             // transmit Pin UART2     (ESP32 only)
